...
public class PlayerLook : MonoBehaviour
{
    ...
    [Header("카메라 참조 객체")]
    public Transform playerCamera; //플레이어의 1인칭 카메라 Transform
    ...
    { 
        ...
        //MouseY : 마우스 상(上)하(下) 이동 -> 위 아래 시선 회전
        ...
        //3. 카메라 상하 회전
        // xRotation 값을 마우스 y 입력에 따라 누적
        // xRotation : 카메라가 "위/아래로 얼마나 돌아갔는가?"를 나타내는 각도
        //xRotation = 0   : 정면
        //xRotation감소   : 아래쪽 보기
        //xRotation증가   : 위쪽 보기
        xRoatation -= mouseY;

        //4. 카메라 회전 제한(고개가 너무 위/아래로 꺽이지 않게)
